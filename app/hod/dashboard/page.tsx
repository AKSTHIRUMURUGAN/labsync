    ...
    <div className="min-h-screen bg-[var(--paper)]">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex gap-6">
                <Link href="/hod/dashboard" className="text-[var(--accent)] font-medium">Dashboard</Link>
                ...
                <Link href="/hod/analytics" className="text-[var(--ink3)] hover:text-[var(--ink)]">Analytics</Link>
              </nav>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[var(--ink3)]">Oversee department operations and performance</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 border border-[var(--paper3)]">
            <div className="text-sm text-[var(--ink3)] mb-1">Faculty Members</div>
          ...
          <div className="bg-white rounded-xl p-6 border border-[var(--paper3)]">
            ...
            <div className="text-3xl font-bold text-[var(--amber)] heading">{stats.activeGroups}</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="text-lg font-bold mb-2 heading">View Analytics</div>
            <p className="text-sm text-white/80">Department performance metrics</p>
          </Link>
          <Link
            href="/hod/faculty/manage"
            className="bg-white border border-[var(--paper3)] rounded-xl p-6 hover:border-[var(--accent)] transition"
          >
            <div className="text-lg font-bold mb-2 text-[var(--ink)] heading">Manage Faculty</div>
            <p className="text-sm text-[var(--ink3)]">Oversee faculty assignments</p>
          </Link>
          <Link
            href="/hod/reports"
            className="bg-white border border-[var(--paper3)] rounded-xl p-6 hover:border-[var(--accent)] transition"
          >
            ...
            <p className="text-sm text-[var(--ink3)]">Department-wide reports</p>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-xl border border-[var(--paper3)] overflow-hidden">
          <div className="px-6 py-4 border-b border-[var(--paper3)]">
            <h3 className="text-xl font-bold text-[var(--ink)] heading">Department Overview</h3>
          </div>
          <div className="p-6">
            <p className="text-[var(--ink3)] text-center py-8">Department data will appear here</p>
          </div>
        </div>
      </main>
    </div>
